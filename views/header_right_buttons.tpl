<div class="btn-group">
	...
	<!-- VIEW README/UPDATES -->
	<div class="form-group inline-block button-wrapper">
		<a name="updates" href="/viewUpdates" target="__blank" class="control-button btn btn-default btn-sm">Help</a>
	</div>
	...
	<form action="/delete" method="post" class="inline-block button-wrapper" enctype="multipart/form-data">						
      ...
      <div class="inline-block form-group button-wrapper">
            <input id="lock" name="lock" type="submit" value="Lock/Unlock" class="control-button btn btn-warning btn-sm"        
                onclick="lockRecord()" \> 
        </div>
